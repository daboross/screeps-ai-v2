...
function activateCustomizations() {
    ...
    // Custom addition
    Creep.prototype.findSpecialty = function () {
        var specialty = this._specialty;
    ...
    // Custom addition
    Creep.prototype.findNextPathPos = function (path) {
        if (!_.isString(path)) {
